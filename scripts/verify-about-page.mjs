...
const checks = [
  ...
  [heroSource.includes("lg:object-right") && heroSource.includes("md:opacity-80"), "Inner hero image composition is right-weighted and integrated"],
  [heroSource.includes("lg:absolute lg:inset-y-0 lg:right-0") && heroSource.includes("lg:w-[62%]"), "Inner hero image fills the desktop right side"],
